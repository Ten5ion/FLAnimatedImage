...
- (instancetype)initWithAnimatedGIFData:(NSData *)data speed:(float)speed optimalFrameCacheSize:(NSUInteger)optimalFrameCacheSize predrawingEnabled:(BOOL)isPredrawingEnabled NS_DESIGNATED_INITIALIZER;
